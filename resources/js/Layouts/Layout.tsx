        ...
        <>
            ...
            <div className="flex flex-col min-h-dvh text-gray-950 bg-white">
                <header className="p-4 flex justify-between items-center sticky top-0 bg-white z-10 border-b border-gray-200">
                    ...
                    <Link href={route("posts.create")} className="hover:opacity-70" aria-label="New Post" title="New Post">
                        <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path fill="currentColor" fillRule="evenodd" d="M1.5 7C1.5 3.96243 3.96243 1.5 7 1.5H17C20.0376 1.5 22.5 3.96243 22.5 7V17C22.5 20.0376 20.0376 22.5 17 22.5H7C3.96243 22.5 1.5 20.0376 1.5 17V7ZM7 2.5C4.51472 2.5 2.5 4.51472 2.5 7V17C2.5 19.4853 4.51472 21.5 7 21.5H17C19.4853 21.5 21.5 19.4853 21.5 17V7C21.5 4.51472 19.4853 2.5 17 2.5H7Z" clipRule="evenodd" />
                            <path fill="currentColor" fillRule="evenodd" d="M11.5 18V6H12.5V18H11.5Z" clipRule="evenodd" />
                            <path fill="currentColor" fillRule="evenodd" d="M18 12.5H6V11.5H18V12.5Z" clipRule="evenodd" />
                        </svg>
                    </Link>
                </header>
                ...
                <footer className="p-4 text-center text-sm text-gray-600 border-t border-gray-200 bg-white">
                    <div className="flex flex-col items-center gap-2">
                        <a href="https://github.com/k-yogo/parka-ojisan" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" aria-label="GitHub Repository">
